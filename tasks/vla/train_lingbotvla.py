        ...
        for cp in candidates:
            ...
            try:
                ...
                if saved_lr_scheduler['base_lrs'][0] != args.train.lr:
                    ...
                    lr_scheduler.base_lrs = [args.train.lr] * len(lr_scheduler.base_lrs)
                    lr_scheduler.step(global_step)
                    logger.info_rank0(f"Scheduler base_lrs after fix: {lr_scheduler.base_lrs}, last_lr: {lr_scheduler.get_last_lr()}")
                else:
    ...
    for epoch in range(start_epoch, args.train.num_train_epochs):
        ...
        for epoch_step in range(start_step, args.train.train_steps):
            ...
            if args.train.data_parallel_mode == "fsdp1":
                ...
                grad_norm = torch.nn.utils.clip_grad_norm_(model.parameters(), max_grad_norm, foreach=False)
